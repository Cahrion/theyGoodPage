...
function myFormItems($myForms)
{
    ...
    foreach ($myForms as  $myFormValue) {
        ...
        if ($formStructure == 'simple') {
            ...
            $html .= "
                <label for='$formName' class='form-label formTextBlocks formTextBlocks'>$formLabel</label>
                <textarea class='form-control formValueBlocks formValueBlocks' name='$formName' id='$formName' rows='3' placeholder='$formPlace'></textarea>
            ";
            ...
            ";
        } else if($formStructure == "multiSelect"){
            $formName           = $myFormValue[1];
            $formLabel          = $myFormValue[2];
            $formOptions        = $myFormValue[3];
            ...
            $html .= "
                <label for='$formName' class='form-label formTextBlocks formTextBlocks'>$formLabel</label>
                <select class='selectpicker w-100' data-live-search='true' multiple name='" . $formName . "[]' id='$formName'>
                    $htmlX
                </select>
            ";
        }
...
function myFormSelectedItems($myForms)
{
    ...
    foreach ($myForms as  $myFormValue) {
        ...
        if ($formStructure == 'simple') {
            ...
            $html .= "
                <label for='$formName' class='form-label formTextBlocks formTextBlocks'>$formLabel</label>
                <textarea class='form-control formValueBlocks formValueBlocks' name='$formName' id='$formName' rows='3' placeholder='$formPlace'>$formValue</textarea>
            ";
